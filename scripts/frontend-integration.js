 ...
 * This file demonstrates how to integrate Walletone with a web frontend
 */

// For React/Vue/Angular applications
export class WalletoneClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new WalletoneClient(provider, contractAddress);
